                    ...
                    <form action="" method="GET" class="row g-3 mb-4 p-3 bg-white rounded shadow-sm mx-1">
                        <div class="col-md-10">
                            <div class="input-group">
                                ...
                                <input type="text" name="keyword" class="form-control border-start-0 ps-0" 
                                       placeholder="Nhập tên môn học..." value="<?php echo e(request('keyword')); ?>">
                            </div>
                        </div>
                        <div class="col-md-2">
                        ...
                        <?php if(request('keyword')): ?>
                            <div class="col-12 ps-3 mt-2">
                                <a href="<?php echo e(route('student.register')); ?>" class="text-danger text-decoration-none small">
                            ...
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($class->teacher->name ?? 'Chưa gán'); ?></td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <div class="progress" style="height: 6px;"><div class="progress-bar <?php echo e($color); ?>" style="width: <?php echo e($percent); ?>%"></div></div>
                                        </td>
                                        ...
                                        <td class="text-end pe-4">
                                            <?php if(in_array($class->id, $my_registered_ids)): ?>
                                                <button class="btn btn-secondary btn-sm" disabled><i class="fas fa-check"></i> Đã ĐK</button>
                                            <?php elseif($class->current_quantity >= $class->max_quantity): ?>
                                                <button class="btn btn-outline-danger btn-sm" disabled>Full</button>
                                            <?php else: ?>
                                                <form action="<?php echo e(route('student.postRegister', $class->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                    ...
                    <div class="card-footer bg-white py-3 border-top-0">
                        <div class="d-flex flex-column flex-md-row justify-content-center align-items-center gap-3">
                            <div class="text-muted small">
                                Hiển thị <strong><?php echo e($classes->firstItem()); ?></strong> - <strong><?php echo e($classes->lastItem()); ?></strong> 
                                / <strong><?php echo e($classes->total()); ?></strong> lớp
                            </div>
                            <div><?php echo e($classes->appends(request()->query())->links('pagination.admin')); ?></div>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\laragon\www\FinalProject\student-manager\resources\views/student/index.blade.php ENDPATH**/ ?>