        ...
        <form action="" method="GET" class="row g-3 mb-4 p-3 bg-white rounded shadow-sm mx-1">
            <div class="col-md-4">
                <input type="text" name="keyword" class="form-control" 
                       placeholder="Tên lớp học..." value="<?php echo e(request('keyword')); ?>" style="font-size: 1rem;">
            </div>
            <div class="col-md-3">
                <select name="teacher_id" class="form-select" style="font-size: 1rem;">
                    ...
                    <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($gv->id); ?>" <?php echo e(request('teacher_id') == $gv->id ? 'selected' : ''); ?>>
                            <?php echo e($gv->name); ?>
            ...
            <?php if(request('keyword') || request('teacher_id') || request('status')): ?>
                <div class="col-12 ps-3 mt-2">
                    <a href="<?php echo e(route('admin.classes.index')); ?>" class="text-danger text-decoration-none" style="font-size: 0.9rem;">
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center fw-bold text-secondary" style="font-size: 1.1rem;"><?php echo e($class->id); ?></td>
                            
                            <td class="ps-4">
                                <span class="fw-bold text-dark" style="font-size: 1.1rem;"><?php echo e($class->name); ?></span>
                            </td>
                                ...
                                <?php if($class->teacher): ?>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <?php if($class->teacher->avatar): ?>
                                            <img src="<?php echo e(asset('storage/' . $class->teacher->avatar)); ?>" 
                                                 alt="<?php echo e($class->teacher->name); ?>"
                                        ...
                                        <?php else: ?>
                                            <div class="rounded-circle bg-light d-flex justify-content-center align-items-center me-2 text-primary fw-bold border" 
                                                ...
                                                <?php echo e(substr($class->teacher->name, 0, 1)); ?>

                                            </div>
                                        <?php endif; ?>

                                        <div>
                                            <div class="fw-bold text-dark" style="font-size: 1rem;"><?php echo e($class->teacher->name); ?></div>
                                            <div class="text-muted" style="font-size: 0.9rem;"><?php echo e($class->teacher->email); ?></div>
                                        </div>
                                    </div>
                                <?php else: ?>
                            ...
                            <td class="text-center" style="width: 200px;">
                                ...
                                <div class="d-flex justify-content-between small mb-1">
                                    <span class="fw-bold text-dark" style="font-size: 0.9rem;"><?php echo e($class->current_quantity); ?></span>
                                    <span class="text-muted" style="font-size: 0.9rem;">/ <?php echo e($class->max_quantity); ?></span>
                                </div>
                            ...
                            <td class="text-center">
                                ...
                                <form action="<?php echo e(route('admin.class.destroy', $class->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('CẢNH BÁO: Xóa lớp sẽ xóa hết đăng ký của SV!\nBạn chắc chắn chứ?');">
        ...
        <div class="card-footer bg-white py-3 border-top-0">
            <div class="d-flex flex-column flex-md-row justify-content-center align-items-center gap-3">
                <div class="text-muted" style="font-size: 1rem;">
                    Hiển thị <strong><?php echo e($classrooms->firstItem()); ?></strong> - <strong><?php echo e($classrooms->lastItem()); ?></strong> 
                    / <strong><?php echo e($classrooms->total()); ?></strong> kết quả
                </div>
                <div>
                    <?php echo e($classrooms->appends(request()->query())->links('pagination.admin')); ?>
