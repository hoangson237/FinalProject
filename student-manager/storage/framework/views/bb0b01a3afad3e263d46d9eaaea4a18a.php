        ...
        <div class="row">
            ...
            <div class="col-md-2 sidebar p-0 d-none d-md-block">
                ...
                <nav class="mt-2">
                    ...
                    <a href="<?php echo e(route('admin.classes.index')); ?>" class="<?php echo e(request()->routeIs('admin.classes.*') || request()->routeIs('admin.class.*') ? 'active' : ''); ?>">
                        <i class="fas fa-chalkboard"></i> Quản lý Lớp học
                    </a>
                    <a href="<?php echo e(route('admin.teachers.index')); ?>" class="<?php echo e(request()->routeIs('admin.teachers.*') ? 'active' : ''); ?>">
                        <i class="fas fa-chalkboard-teacher"></i> Quản lý Giáo viên
                    </a>
                    <a href="<?php echo e(route('admin.students.index')); ?>" class="<?php echo e(request()->routeIs('admin.students.*') ? 'active' : ''); ?>">
...
</html><?php /**PATH G:\laragon\www\FinalProject\student-manager\resources\views/layouts/admin.blade.php ENDPATH**/ ?>